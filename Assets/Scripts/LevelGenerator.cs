...
public class LevelGenerator : MonoBehaviour
{
    ...
    {0,0,0,0,0,2,5,4,4,0,3,4,4,10},
    {2,2,2,2,2,1,5,3,3,0,4,9,9,9},
        ...
        if(gameObject.tag == "UIborder"){
            ...
            switch(cornerlevelMap[col,row]){
                ...
                case 8:
                    ...
                    break;
                case 9:
                    sublist.Add(Instantiate(wallObjectList[9], new Vector3(xPos, yPos, 0), Quaternion.identity));
                    break;
                case 10: 
                    sublist.Add(Instantiate(wallObjectList[10], new Vector3(xPos, yPos, 0), Quaternion.identity));
                    break;
            }
        }
    }
